//go:generate echo "https://atcoder.jp/contests/abc108/tasks/abc108_b"
package main
...
func solve(x1, y1, x2, y2 int) (int, int, int, int) {
	a, b := x2-x1, y2-y1
	x3, y3 := x2-b, y2+a
	return x3, y3, x3 - a, y3 - b
}

func main() {
	x1, y1, x2, y2 := scan.Int(), scan.Int(), scan.Int(), scan.Int()
	fmt.Println(solve(x1, y1, x2, y2))
}
