//go:generate echo "https://atcoder.jp/contests/abc154/tasks/abc154_a"
package main
...
func Solve(S, T string, A, B int, U string) (int, int) {
	if S == U {
		A--
	}
	if T == U {
...
func main() {
	S, T, A, B, U := scan.String(), scan.String(), scan.Int(), scan.Int(), scan.String()
	fmt.Println(Solve(S, T, A, B, U))
}
