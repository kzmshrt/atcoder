//go:generate echo "https://atcoder.jp/contests/abc168/tasks/abc168_c"
package main
...
func main() {
	A, B, H, M := scan.Float64(), scan.Float64(), scan.Float64(), scan.Float64()
	hrad, mrad := (1-(H+M/60)/3)*math.Pi/2, (1-M/15)*math.Pi/2
	fmt.Printf("%.20f\n", math.Sqrt(math.Pow(A*math.Cos(hrad)-B*math.Cos(mrad), 2)+math.Pow(A*math.Sin(hrad)-B*math.Sin(mrad), 2)))
}
