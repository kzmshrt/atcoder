//go:generate echo "https://atcoder.jp/contests/abc169/tasks/abc169_c"
package main
...
func (s *scanner) BigFloat() *big.Float { f, _ := new(big.Float).SetString(s.String()); return f }

func (s *scanner) BigFloats(n int) []*big.Float {
	a := make([]*big.Float, n, n)
	for i := range a {
		a[i] = s.BigFloat()
	}
	return a
