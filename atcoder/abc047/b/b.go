//go:generate echo "https://atcoder.jp/contests/abc047/tasks/abc047_b"
package main
...
func main() {
	W, H, N := scan.Int(), scan.Int(), scan.Int()
	u, b, l, r := H, 0, 0, W
	for i := 0; i < N; i++ {
		switch x, y, a := scan.Int(), scan.Int(), scan.Int(); a {
		case 1:
			chmax(&l, x)
		case 2:
			chmin(&r, x)
	...
	fmt.Println(imax(u-b, 0) * imax(r-l, 0))
}
