//go:generate echo "https://atcoder.jp/contests/abc059/tasks/abc059_a"
package main
...
func main() {
	fmt.Println(string([]rune{unicode.ToUpper(rune(scan.String()[0])), unicode.ToUpper(rune(scan.String()[0])), unicode.ToUpper(rune(scan.String()[0]))}))
}
