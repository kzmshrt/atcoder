//go:generate echo "https://atcoder.jp/contests/abc090/tasks/abc090_b"
package main
...
func solve1(A, B int) int {
	isPalindromeNumber := func(X int) bool {
		for l, r := 0, 4; l < r; l, r = l+1, r-1 {
			if X/ipow(10, l)%10 != X/ipow(10, r)%10 {
				return false
			}
		}
		return true
